...
struct for_each_ref_cpu_impl<false>
{
        ...
        )
    {
        ...
        typedef typename mpl::next<Iterator>::type iter;
        for_each_ref_cpu_impl<boost::is_same<iter,LastIterator>::value>
            ::execute( static_cast<iter*>(0), static_cast<LastIterator*>(0), static_cast<TransformFunc*>(0), f);
    }
};
...
inline void for_each_cpu_ref(F & f, Sequence* = 0, TransformOp* = 0)
{
    ...
    aux::for_each_ref_cpu_impl< boost::is_same<first,last>::value >
        ::execute(static_cast<first*>(0), static_cast<last*>(0), static_cast<TransformOp*>(0), f);
}
...
{
    for_each_cpu_ref<Sequence, identity<> >(f);
}
