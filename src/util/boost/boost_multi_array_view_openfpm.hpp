/*
 * boost_multi_array_view.hpp
 *
 *  Created on: Jun 7, 2018
 *      Author: i-bird
 */

#ifndef OPENFPM_DATA_SRC_UTIL_BOOST_MULTI_ARRAY_VIEW_OPENFPM_HPP_
...
protected:
  template <typename,std::size_t> friend class multi_array_impl_base_openfpm;
...
public:
  typedef boost::detail::multi_array::multi_array_view_openfpm<element,N> type;
};
...
class const_array_view_gen_openfpm {
  typedef typename Array::element element;
public:
  typedef boost::detail::multi_array::const_multi_array_view_openfpm<element,N> type;
};

} // namespace boost


#endif /* OPENFPM_DATA_SRC_UTIL_BOOST_MULTI_ARRAY_VIEW_OPENFPM_HPP_ */
