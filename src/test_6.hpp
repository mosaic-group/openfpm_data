...
void test_6(layout_cpu<3, grid<3,Point<float>>, memory_cpu<memory_cpu_type<Point<float>>::type> > & c3)
{
...
void test2(layout_gpu<3, grid<3,Point<float>>, memory_gpu<memory_gpu_type<Point<float>>::type> > & c3)
{
	  std::cout << "3D Array with grid_key (without redundant dimension): " << "\n";
