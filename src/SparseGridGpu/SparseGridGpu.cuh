...
//                applyStencilInsertHost<stencil>(args...);
                std::cout << __FILE__ << ":" << __LINE__ << " No insert mode stencil application available on Host!" << std::endl;
                break;
            default:
                std::cout << __FILE__ << ":" << __LINE__  << " Unsupported mode" << std::endl;
                break;
        }
    }
...
//                applyBoundaryStencilInsert<stencil>(args...);
                std::cout << __FILE__ << ":" << __LINE__ << "No insert mode stencil application available on BOUNDARY!" << std::endl;
                break;
            default:
                std::cout << __FILE__ << ":" << __LINE__ << "Only STENCIL_MODE_INPLACE and STENCIL_MODE_INSERT are supported" << std::endl;
                break;
        }
    }
    template<typename stencil1, typename stencil2, typename ... otherStencils, typename... Args>
				...
				mgpu::ofp_context_t &context)
	{
		...
		if (n_pnt != 0)
		{
			...
			std::cout << __FILE__ << ":" << __LINE__ << "  error still to implement on HIPCC " << std::endl;
			...
			openfpm::sort((indexT *)tmp.template getDeviceBuffer<0>(),
