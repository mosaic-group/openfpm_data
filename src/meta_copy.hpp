...
{
	meta_copy(T src[N1][N2], T dst[N1][N2])
	{
		for (size_t i1 = 0 ; i1 < N1 ; i1++)
		{
...
{
	meta_copy(T src[N1][N2][N3], T dst[N1][N2][N3])
	{
		for (size_t i1 = 0 ; i1 < N1 ; i1++)
		{
			for (size_t i2 = 0 ; i2 < N2 ; i2++)
...
{
	meta_copy(T src[N1][N2][N3][N4], T dst[N1][N2][N3][N4])
	{
		for (size_t i1 = 0 ; i1 < N1 ; i1++)
		{
			for (size_t i2 = 0 ; i2 < N2 ; i2++)
...
{
	meta_copy(T src[N1][N2][N3][N4][N5], T dst[N1][N2][N3][N4][N5])
	{
		for (size_t i1 = 0 ; i1 < N1 ; i1++)
		{
			for (size_t i2 = 0 ; i2 < N2 ; i2++)
			{
				for (size_t i3 = 0 ; i3 < N3 ; i3++)
				{
					for (size_t i4 = 0 ; i4 < N4 ; i4++)
					{
						...
						{
							src[i1][i2][i3][i4][i5] = dst[i1][i2][i3][i4][i5];
						}
					}
				}
			}
...
{
	meta_copy(T src[N1][N2][N3][N4][N5][N6], T dst[N1][N2][N3][N4][N5][N6])
	{
		for (size_t i1 = 0 ; i1 < N1 ; i1++)
		{
			for (size_t i2 = 0 ; i2 < N2 ; i2++)
				...
				for (size_t i3 = 0 ; i3 < N3 ; i3++)
				{
					for (size_t i4 = 0 ; i4 < N4 ; i4++)
					{
						for (size_t i5 = 0 ; i5 < N5 ; i5++)
						{
							...
							{
								src[i1][i2][i3][i4][i5][i6] = dst[i1][i2][i3][i4][i5][i6];
							}
						}
					}
				}
...
{
	meta_copy(T src[N1][N2][N3][N4][N5][N6][N7], T dst[N1][N2][N3][N4][N5][N6][N7])
	{
		for (size_t i1 = 0 ; i1 < N1 ; i1++)
		{
			for (size_t i2 = 0 ; i2 < N2 ; i2++)
					...
					for (size_t i4 = 0 ; i4 < N4 ; i4++)
					{
						for (size_t i5 = 0 ; i5 < N5 ; i5++)
						{
							for (size_t i6 = 0 ; i6 < N6 ; i6++)
							{
								...
								{
									src[i1][i2][i3][i4][i5][i6][i7] = dst[i1][i2][i3][i4][i5][i6][i7];
								}
							}
						}
					}
...
{
	meta_copy(T src[N1][N2][N3][N4][N5][N6][N7][N8], T dst[N1][N2][N3][N4][N5][N6][N7][N8])
	{
		for (size_t i1 = 0 ; i1 < N1 ; i1++)
		{
			for (size_t i2 = 0 ; i2 < N2 ; i2++)
						...
						for (size_t i5 = 0 ; i5 < N5 ; i5++)
						{
							for (size_t i6 = 0 ; i6 < N6 ; i6++)
							{
								for (size_t i7 = 0 ; i7 < N7 ; i7++)
								{
									...
									{
										src[i1][i2][i3][i4][i5][i6][i7][i8] = dst[i1][i2][i3][i4][i5][i6][i7][i8];
									}
								}
							}
						}
...
{
	meta_copy(T src[N1][N2][N3][N4][N5][N6][N7][N8][N9], T dst[N1][N2][N3][N4][N5][N6][N7][N8][N9])
	{
		for (size_t i1 = 0 ; i1 < N1 ; i1++)
		{
			for (size_t i2 = 0 ; i2 < N2 ; i2++)
							...
							for (size_t i6 = 0 ; i6 < N6 ; i6++)
							{
								for (size_t i7 = 0 ; i7 < N7 ; i7++)
								{
									for (size_t i8 = 0 ; i8 < N8 ; i8++)
									{
										...
										{
											src[i1][i2][i3][i4][i5][i6][i7][i8][i9] = dst[i1][i2][i3][i4][i5][i6][i7][i8][i9];
										}
									}
								}
							}
...
{
	meta_copy(T src[N1][N2][N3][N4][N5][N6][N7][N8][N9][N10], T dst[N1][N2][N3][N4][N5][N6][N7][N8][N9][N10])
	{
		for (size_t i1 = 0 ; i1 < N1 ; i1++)
		{
			for (size_t i2 = 0 ; i2 < N2 ; i2++)
								...
								for (size_t i7 = 0 ; i7 < N7 ; i7++)
								{
									for (size_t i8 = 0 ; i8 < N8 ; i8++)
									{
										for (size_t i9 = 0 ; i9 < N9 ; i9++)
										{
											...
											{
												src[i1][i2][i3][i4][i5][i6][i7][i8][i9][i10] = dst[i1][i2][i3][i4][i5][i6][i7][i8][i9][i10];
											}
										}
									}
								}
